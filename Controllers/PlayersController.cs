...
namespace ProjectComp2084.Controllers
{
    ...
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlayerID,FirstName,LastName,Age,TeamID")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerID,FirstName,LastName,Age,TeamID")] Player player)
        {
